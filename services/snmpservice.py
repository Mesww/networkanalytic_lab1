...
# Router details
router_ip = (
    config.get("ROUTER_IP") or "localhost"
)  # Replace with the router's IP address
community = config.get("COMMUNITY") or "public"  # Replace with your community string

oids = [
    {"name": "router_name", "oid": "1.3.6.1.2.1.1.5"},
    {"name": "interface_names", "oid": "1.3.6.1.2.1.2.2.1.2"},
    {"name": "bandwidth", "oid": "1.3.6.1.2.1.2.2.1.5"},
    {"name": "traffic_in", "oid": "1.3.6.1.2.1.2.2.1.10"},
    {"name": "traffic_out", "oid": "1.3.6.1.2.1.2.2.1.16"},
]
